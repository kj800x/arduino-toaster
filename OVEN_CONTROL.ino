...
#define _LCDML_CONTROL_cfg      2  // serial
...
// settings
  ...
  #define _LCDML_CONTROL_digital_up              4 //9
  #define _LCDML_CONTROL_digital_down            5 //10
  #define _LCDML_CONTROL_digital_quit            11
  #define _LCDML_CONTROL_digital_left            6 //12
  #define _LCDML_CONTROL_digital_right           7 //13
// *********************************************************************
// setup
void LCDML_CONTROL_setup()
{
